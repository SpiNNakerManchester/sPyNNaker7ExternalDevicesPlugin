...
edp_link = 'http://spynnakerexternaldevicesplugin.readthedocs.io/en/latest/'
...
project = u'sPyNNaker7ExternalDevicesPlugin'
...
htmlhelp_basename = 'sPyNNaker7ExternalDevicesPlugindoc'
...
latex_documents = [
  ('index', 'sPyNNaker7ExternalDevicesPlugin.tex',
   u'sPyNNaker7ExternalDevicesPlugin Documentation', u'', 'manual'),
]
...
man_pages = [
    ('index', 'sPyNNaker7ExternalDevicesPlugin',
     u'sPyNNaker7ExternalDevicesPlugin Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'sPyNNaker7ExternalDevicesPlugin',
   u'sPyNNaker7ExternalDevicesPlugin Documentation', u'',
   'sPyNNaker7ExternalDevicesPlugin', '', 'Miscellaneous'),
]
...
epub_title = u'sPyNNaker7ExternalDevicesPlugin'
epub_author = u''
epub_publisher = u''
...
for f in os.listdir("."):
    if (os.path.isfile(f) and f.endswith(
        ...
        os.remove(f)
apidoc.main([None, '-o', ".", "../../spynnaker7_external_devices_plugin"])
